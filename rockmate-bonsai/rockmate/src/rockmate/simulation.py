...
class Step:
    def __init__(self, op_list: List[Op]) -> None:
        ...
        for op in main_op_list:
            ...
            #     # Dat: Let's treat all offloadOps as regular comp ops
            #     if isinstance(op.target, Parameter):
            #         ofl_ops.append(op)
            #     else:
            #         ofl_act_ops.append(op)
            # elif isinstance(op, PrefetchOp):
            #     # Dat: Let's treat all prefetchOps as regular comp ops
            #     if isinstance(op.target, Parameter):
            #         prf_ops.append(op)
            #     else:
...
class Simulator:
    ...
    def create_steps(self):
        ...
        for i, op in enumerate(self.op_list):
            # print(f"Creating steps, processing op {i}: {op}")
        ...
        # print steps and their ops
        # print(f"Initial steps and their ops:")
