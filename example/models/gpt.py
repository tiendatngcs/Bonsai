...
def getTransformer(d_model=768, n_head=12, n_ctx=1024, dropout=0.1):
    attn = Attention(
        d_model=d_model,
        n_head=n_head,
        d_head=64,
...
class GPT2(nn.Module):
    def __init__(
        ...
        block = getTransformer(
            d_model=d_model, n_head=n_head, n_ctx=n_ctx, dropout=dropout
        )
